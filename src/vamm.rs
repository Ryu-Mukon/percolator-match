...
pub fn process_call(
    ...
    let ret = MatcherReturn {
        ...
        // ABI v3: echo the requested asset. The engine rejects the whole TradeCpi
        // with InvalidAccountData if this doesn't match — which is why only asset
        // 0 (SOL) ever traded while BTC/ETH failed.
